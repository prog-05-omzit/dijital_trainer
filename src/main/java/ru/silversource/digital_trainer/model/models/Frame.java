...
public class Frame {
    ...
    public Frame(List<PeopleDTO> people) {
    ...
    public Frame(FrameDTO frameDTO) {
        pose_keypoints_2d = getPoints2D(frameDTO.getPeople().get(0).getPose_keypoints_2d());
        face_keypoints_2d = getPoints2D(frameDTO.getPeople().get(0).getFace_keypoints_2d());
        hand_left_keypoints_2d = getPoints2D(frameDTO.getPeople().get(0).getHand_left_keypoints_2d());
        hand_right_keypoints_2d = getPoints2D(frameDTO.getPeople().get(0).getHand_right_keypoints_2d());
        pose_keypoints_3d = getPoints3D(frameDTO.getPeople().get(0).getPose_keypoints_3d());
        face_keypoints_3d = getPoints3D(frameDTO.getPeople().get(0).getFace_keypoints_3d());
        hand_left_keypoints_3d = getPoints3D(frameDTO.getPeople().get(0).getHand_left_keypoints_3d());
        hand_right_keypoints_3d = getPoints3D(frameDTO.getPeople().get(0).getHand_right_keypoints_3d());
    }
